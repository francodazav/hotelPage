...
export const createTables = async () => {
  ...
  await db.execute(
    "CREATE TABLE IF NOT EXISTS reservations(id INTEGER PRIMARY KEY AUTOINCREMENT ,hotel_id INTEGER NOT NULL,user_id VARCHAR(36) NOT NULL, name VARCHAR(36) NOT NULL, lastname VARCHAR(36) NOT NULL,username VARCHAR(36) NOT NULL,email VARCHAR(40) NOT NULL,rsv_confirm VARCHAR(12) NOT NULL UNIQUE, fecha_in DATE NOT NULL, fecha_out DATE NOT NULL)"
  );
  await db.execute(
